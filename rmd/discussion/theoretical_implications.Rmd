...
concepts in their decisions, but that they are also capable of making nuanced
trade-offs and can be assisted by decision aides. Understanding how
decision-making in capital allocation is constrained and biased is important in
order to improve decision-making. Even if decisions are largely consistent with
normative concepts, falling prey to the biases identified in the thesis can
...
informative than the aggregated measure. Prior work shows that people can reason
about distributions effectively when experiencing the sampling directly [e.g.,
@hertwig2004; @carvalho2021]. Chapter \@ref(anecdotes) shows that people
struggle to use this information when it is described verbally.
...
discussed in Chapter \@ref(interstitial-2), in both Chapters \@ref(alignment)
...
people to use statistical concepts for more complex moderation.
...
Much work has investigated visualising uncertainty information [@bostrom2008;
@maceachren1992; @kinkeldey2017; @padilla2018; @davis1997; @ristovski2014;
@brodlie2012; @johnson2003; @potter2012; @lipkus1999; @lipkus2007;
@spiegelhalter2011; @pang1997; @kox2018; @lapinski2009; @torsneyweir2015]. A
Hypothetical Outcome Plot [HOP\; @kale2019; @hullman2015] expresses variance
...
@jaramillo2019 is likely to facilitate people's understanding of the importance
...
distribution. Ultimately, it seems that visualisations of the effects of certain
...
At the implicit level an individual can only use a certain system of knowledge,
while it is only at the explicit level that they develop insight into the
system. For instance, young children can use closed class words such as "the" or
"to", but only identify them as words later in development. Adults may have a
similar distinction in knowledge representation. Concepts that can be used when
experienced directly, such as in risky choice from experience, are not
represented in a way that they can be used when presented descriptively, such as
in risky choice from description. This kind of distinction may explain the why
...
For instance, @smith1991 reviewed the heuristics and biases literature and
...
accounts to inform their decisions because of their higher salience, compared to
