...
on resource allocation decisions [@birshan2013]. This section will review some
...
instance, @lovallo2020 suggested that companies change the frequency that they
...
project attributes, potentially reducing forecast error. @koller2017 found that
...
turn be addressed [@flyvbjerg2018].
