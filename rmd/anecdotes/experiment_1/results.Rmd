...
than when seeing the high similarity anecdote and statistics,
...
(ref:plot-anecdotes-1-allocation-combined) Mean allocation to the target project. Error bars represent 95% confidence intervals.
...
which they saw the same, but with enhanced statistics.
Figure \@ref(fig:plot-anecdotes-1-allocation) shows these data. The two-way
interaction between similarity and the two types of anecdote & statistics
...
(ref:plot-anecdotes-1-allocation) Mean allocation to the target project. Error bars represent 95% confidence intervals.
