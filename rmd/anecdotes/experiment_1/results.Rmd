...
was significant, `r results_anecdotes_1$allocation$condition`. Planned
...
statistics, `r results_anecdotes_1$allocation$combined_high_statistics_NA`; but
...
`r results_anecdotes_1$allocation$combined_enhanced`. This suggests that
