...
*anecdote & enhanced statistics condition*. Unlike the anecdote & enhanced
statistics condition in @wainberg2013, the statistical information here is
actually "enhanced" because of the accompanying text. Experiment 1 tests whether
the effect from @wainberg2018---additional information protecting against
