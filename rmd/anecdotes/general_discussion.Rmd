...
more focused on negative outcomes in the medical domain. It is also surprising
not to find an asymmetry because of loss aversion.
...
of the sample and the shape of the distribution. Further, future research should
use realistic incentives to increase the ecological validity of the findings.
...
are all just as similar to the target. @lovallo2012 found that similarity
