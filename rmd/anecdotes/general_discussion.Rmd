...
The first novel finding from these experiments is that participants modified
their use of anecdotal evidence depending on the anecdote's similarity.
Specifically, if the anecdote appeared relevant, participants used it in their
decisions. However, when it appeared irrelevant, participants almost entirely
relied on statistics. The findings for high anecdotal similarity are largely
congruent with findings from other work investigating anecdotal bias in business
decision-making. As in @wainberg2013 and @wainberg2018, this chapter found that
people allocated less capital to a project when presented with statistical
