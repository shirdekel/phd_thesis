...
(ref:plot-anecdotes-2-lm-allocation-relevance-specific-similarity) Mean allocations to the target project, by specific relevance rating, similarity condition, and valence condition.
