...
To investigate whether anecdotal bias was moderated by anecdotal similarity, the
...
evidence for the moderating effect of similarity on anecdotal bias for both
negative and positive anecdotes. Participants appeared to be sensitive to the
relevance of the anecdote to the target problem.
