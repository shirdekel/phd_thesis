...
would accept 100 plays of the same gamble. @samuelson1963 argued that this
choice is irrational, but other work suggests that it is consistent with
expected utility theory when certain assumptions are clarified [e.g., @ross1999;
@aloysius2007]. However, a normative discussion is out of the scope of the
...
*single-play* gamble), than when making a single decision about multiple
identical gambles (a *multi-play* gamble).[^terminology]
...
[@keren1987; @keren1991; @dekay2006], preference reversals [@wedell1990],
ambiguity aversion [@liu2009], and the illusion of control [@koehler1994].
Participants are also more likely to use explicitly provided EVs in multi-play
gambles [@li2003], show eye movements more congruent with an EV model than
single-play gambles [@su2013], and judge multi-play gambles as riskier
[@joag1990].
...
outcome distribution of the @samuelson1963 gamble played 10 times. These kinds
...
individual description-based gambles presented sequentially [e.g., @ert2013;
@joag1990]. However, these studies did not attempt to facilitate participants'
risk aggregation. @haisley2008 provided limited evidence for facilitating risk
...
experimental artefact of immediate feedback. Both the original @samuelson1963
anecdote and its subsequent replications show that people do have an intuition
for aggregation even without the risk being calculated exactly for them. This
chapter tests whether that same intuition can be elicited and applied across
sets of unique bets. What are the minimal conditions required to encourage
aggregation? The multi-play gamble work suggests that participants can engage in
a more intuitive form of aggregation when provided with the right contextual
cues. Investigating the effects of more subtle cues will help shed light on the
...
participants the number of total options. @sokolhessner2009 and
@sokolhessner2012 reduced risk aversion using lengthy instructions with an
explanation to "think like a trader". This meant considering all the
repeated-play gambles as a portfolio, as opposed to considering them
individually. However, a more subtle cue could involve simply making
participants aware that they are going to be making a series of choices. This
kind of contextual cue may be sufficient to encourage risk aggregation. If
people possess such an intuitive understanding, as suggested above, then simply
being encouraged to consider a set of choices together in more subtle ways than
explicit instruction will also facilitate aggregation.
...
risk across decisions. @dekay2005 found that multi-play effects are not seen
...
seeking in the domain of losses [@maccrimmon1986; @swalm1966; @lovallo2020].
...
three managers said they would accept the investment [@thaler1999]. However, the
...
choice bracketing is important and currently under-utilised [@lovallo2020]. The
...
[e.g., @benartzi1999]. Otherwise, people typically prefer low risk, low EV,
