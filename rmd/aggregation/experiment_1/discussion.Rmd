...
participants had a certain aspiration level [@lopes1996] that they were
...
favourable. @barron2003 [p. 219] specifically did not tell participants about
the number of gambles they would experience to "avoid an 'end of task' effect
(e.g., a change in risk attitude)". @barron2003 provided participants with
...
decisions in Experiment 1. @barron2010 found that the gambler's fallacy (in a
roulette prediction task) emerges when information about past outcomes was
displayed sequentially, but not when it is displayed all at once. @haisley2008
