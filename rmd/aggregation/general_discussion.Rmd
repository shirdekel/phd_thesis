...
presentation, and awareness of the number of projects. [Experiment
2](#aggregation-2) found evidence for the effect of an outcome distribution but
...
@redelmeier1992]. However, when distributions have been previously used,
...
to encourage aggregation. @hsee1999 found that useful, but hard-to-interpret,
...
the decision set was the risk of the projects. Contrary to @hsee1999, it seemed
...
effects that were seen in [Experiment 1](#results-aggregation-1) but not
...
[@lovallo2020]. This is especially important for those that would still have
