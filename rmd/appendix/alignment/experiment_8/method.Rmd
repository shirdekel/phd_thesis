...
```{r alignment-low-reliability-explicit, fig.cap = "Experiment 8 low alignment, verbal reliability display. Cropped for space (full display has eight projects)."}
here(
...
```{r alignment-low-reliability-implicit, fig.cap = "Experiment 8 low alignment, numerical reliability display. Cropped for space (full display has eight projects)."}
here(
  materials_alignment_7,
...
```{r alignment-high-reliability-explicit, fig.cap = "Experiment 8 high alignment, high reliability display. Cropped for space (full display has eight projects)."}
here(
  materials_alignment_7,
...
```{r alignment-high-reliability-implicit, fig.cap = "Experiment 8 high alignment, numerical reliability display. Cropped for space (full display has eight projects)."}
here(
  materials_alignment_7,
