...
reliability amount $\times$ NPV amount interaction was significant,
`r results_alignment_5$forecast_sd$alignment_reliability_amount_npv_amount`.
The interaction between the linear NPV trend and NPV presence was significant in
both the high alignment condition,
`r results_alignment_5$forecast_sd$Absent_Present_linear_high`, and in the
low alignment condition,
`r results_alignment_5$forecast_sd$Absent_Present_linear_low`.
