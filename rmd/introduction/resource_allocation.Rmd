## Resource allocation in hierarchical organisations {#resource-allocation}
...
@coase1937], shared resources [@wernerfelt1984; @barney1991], increased
competitive advantage [@porter1980; @porter1985], and increased synergies
[@barney1988]. The underlying logic is the same: a multi-divisional organisation
...
related to many other approaches in the management literature [@mahoney1992;
@barney1991]. The resource allocation process itself is one of the most
important drivers of the strategic outcomes of an organisation [@bower1970;
@bower2005]. A *resource* can refer to many types of assets that an organisation
owns, both tangible and intangible, of which capital is only one
[@wernerfelt1984]. In the resource allocation process, business-level managers
...
most frequently used metrics for project evaluation [@graham2001; @remer1993].
...
money), as seen in Equation \@ref(eq:npv):
...
also been shown to be associated with profitability [@grant1988]. Some of this
discrepancy has been explained to be due to the specific measures used
[@lubatkin1986]. It may also be because most studies used Standard Industrial
Classification (SIC) codes to measure diversification [e.g., @rumelt1974],
...
the sum of its parts (known as a *diversification discount*). In fact, many
organisations that acquired other businesses to diversify subsequently end up
divesting them [@porter1987].
...
effects of psychological biases on managerial strategy [@powell2011]. I discuss
