...
[@schwenk1984; @das1999; @mccray2002]. Further, an organisation's success
ultimately depends on "strategic" decisions made by top level managers
[@mazzolini1981]. Therefore, despite early work attempted to analyse such
decisions using a structured organisational analysis [e.g., @mintzberg1976], it
...
considering the success of projects in hindsight [@bukszar1988;
@christensenszalanski1991]. This means that it less likely that managers will be
...
understood in external markets [@markowitz1952]. The psychological literature
