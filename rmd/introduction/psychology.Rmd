## The Psychology of Capital Allocation {#psychology}
...
@mccray2002]. Further, an organisation's success ultimately depends on strategic
decisions made by top level managers [@mazzolini1981]. Therefore, despite early
work attempting to analyse such decisions using a structured organisational
analysis [e.g., @mintzberg1976], it is important to understand the potential
influence of psychological biases on managerial decisions. Research in the field
of behavioural strategy has started to do this [@powell2011].
...
in certain environments [@haselton2009; @gigerenzer2008; @bettis2017]. However,
...
between the available options, regardless of their composition. This *naive
diversification* bias was also found in capital allocation for hierarchical
firms [@bardolet2011]. Managers allocated capital equally across the available
...
are not operating at their full potential [@arrfelt2015; @bardolet2010].
...
actual profitability levels [@bardolet2017]. This was attributed to a
...
Managers also do not always seem to seek profit maximisation. @shapira2014
...
has been shown in laypeople [@langer1975; @mannes2013; @soll2004; @puri2007], as
well as in IT professionals [@mckenzie2008] and managers [@lovallo2003;
@kahneman1993; @baroneadesi2013]. This is important for higher-level managers
...
the success of projects in hindsight [@bukszar1988; @christensenszalanski1991].
...
-\lambda(-x)^\beta \text{ if } x < 0, (\#eq:value-function) \end{array} \right.
\end{equation}
...
complex situation. @lovallo2020 found that the risk profiles of lower-level
...
understood in external markets [@markowitz1952].

@lovallo2020 suggested that lower-level managers’ failure to aggregate risk to
