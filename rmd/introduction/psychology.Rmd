## The psychology of resource allocation
...
changes’ subjective value (y-axis). An increase in wealth ($+x = 1$) brings
about an equivalent increase of value ($+y^{0.88} = 1$). However, a decrease in
the same amount of wealth ($-x = -1$) brings about a decrease in value 2.25
times the value of the equivalent gain ($-2.25y^{0.88} = 2.04$).
