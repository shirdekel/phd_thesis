...
required to reproduce this document can be found through this link:
https://tinyurl.com/shir-thesis. This GitFront repository is simply a copy of a
private GitHub repository, and can be navigated and cloned using a similar
interface to GitHub.
