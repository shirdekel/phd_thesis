...
(ref:plot-alignment-2-allocation) Mean allocation. In mixed factorial designs, error bars cannot be used to make inferences by "eye" across all conditions. Therefore, error bars were not included, and instead raw data was plotted in the background. When interpreting this figure, consider the linear trends in NPV Amount.
