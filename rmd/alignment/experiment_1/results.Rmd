...
(ref:plot-alignment-2-allocation) Mean allocation. Error bars represent 95% confidence intervals based on the multivariate model. Note that this mixed factorial design does not allow for using confidence intervals to make inferences by "eye" across conditions.
