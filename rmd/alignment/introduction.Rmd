...
projects is Net Present Value [NPV\; @graham2001]. NPV is the difference between
...
to often be inaccurate and prone to optimism bias [@lovallo2003; @puri2007].
...
from numerical sequences [@rosenbaum2020]. However, people struggle to use
variance information when it is represented numerically [@galesic2010;
@konold1993; @vivalt2018; @batteux2020].

### Experiment summary

In [Experiment 1](#alignment-2) I investigated the effect of alignment on the
...
In [Experiment 2](#alignment-3), I investigated the decision-making of
...
manipulated the level of *numerical* reliability that is associated with it.
...
In [Experiment 3](#alignment-8) I again tested the alignment and reliability
