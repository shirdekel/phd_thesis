...
(ref:plot-alignment-3-allocation) Mean allocation across NPV amount, by alignment and reliability amount conditions. Error bars represent 95% confidence intervals, calculated from the within-subjects SEs using the method from @cousineau2014. Raw data are plotted in the background.
